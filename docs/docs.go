...
// 2021-08-19 17:32:18.198099184 +0100 BST m=+0.091431810
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/encoder.Request"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "encoder.Request": {
            ...
            "properties": {
                ...
                "upload": {
                    "type": "object",
                    "$ref": "#/definitions/encoder.Upload"
                }
            }
        },
        "encoder.Storage": {
        ...
        "encoder.Upload": {
            ...
            "properties": {
                ...
                "metaData": {
                    "description": "PartialUploads null",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/encoder.MetaData"
                    }
                },
                "offset": {
                    "type": "integer"
                ...
                "storage": {
                    "type": "object",
                    "$ref": "#/definitions/encoder.Storage"
                }
            }
        },
        "misc.List": {
